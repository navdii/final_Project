...
import ca.sheridancollege.project.Models.ComputerPlayer;
import ca.sheridancollege.project.Models.HumanPlayer;
import ca.sheridancollege.project.Models.GroupOfCards;
import ca.sheridancollege.project.Models.Card;
import ca.sheridancollege.project.Models.Game;
import ca.sheridancollege.project.Models.Player;
...
public class GamePlay extends Game {
    ...
    static String suits;
    static int rank;
    public final static String name = "War Game";
    ...
    public static int selectCard(Player player) {
        ...
        if (getRankInput(rank) && getSuitInput(suits)) {
            for (Card c : player.getCard()) {
                i++;
                if (suits.equalsIgnoreCase(String.valueOf(c.getS()))) {
                    if (rank == c.getR()) {
